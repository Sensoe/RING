...
public class Chasseur extends Combattant{
	...
	public Chasseur(String nom, int force, int dexterite, int intelligence, int concentration){
		super(nom, force, dexterite, intelligence, concentration);
	}
	
	public boolean regleStat(){
		if(this.force >= 20 && this.dexterite >=20 && this.intelligence >=20 && 
				this.concentration >=20 && this.pointDispo() >= 0)
				return true;
		return false;
	}
